...
from chunkipy.text_splitters import BaseTextSplitter, SeparatorTextSplitter
...
class TestTextChunker(unittest.TestCase):
    ...
    def test_chunk_short_text_word_estimator(self):
        ...
        text_chunker = TextChunker(chunk_size=100, tokens=True)
        text = "This is a short text."
        expected_chunks = ["This is a short text."]
        chunks_text = text_chunker.chunk(text).get_all_text()
        self.assertEqual(chunks_text, expected_chunks)
    ...
    def test_chunk_text_char_estimator(self):
        ...
        text_chunker = TextChunker(chunk_size=30, tokens=False)
    ...
    def test_chunk_long_text(self):
        text_chunker = TextChunker(chunk_size=105, tokens=False)
    ...
    def test_chunk_tokenized_text_custom_split_strategy(self):
        ...
        text_chunker = TextChunker(chunk_size=10, tokens=True, text_splitters=text_splitters)
    ...
    def test_chunk_tokenized_text_custom_tokenizer_and_custom_split_strategy(self):
        ...
        text_chunker = TextChunker(chunk_size=2, tokens=True, 
    ...
    def test_overlapping_less_than_max(self):
        ...
        text_chunker = TextChunker(50, tokens=True, overlap_ratio=0.4)
    ...
    def test_overlapping(self):
        ...
        text_chunker = TextChunker(50, tokens=True, overlap_ratio=0.3)
