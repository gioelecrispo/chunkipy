...
if __name__ == "__main__":
    ...
    chunkizer = TextChunker(512, tokens=True, token_estimator=bert_token_estimator)
    chunks = chunkizer.chunk(text)
    ...
    chunkizer = TextChunker(chunk_size=8, tokens=True, split_strategies=[split_by_arrow])
    chunks = chunkizer.chunk(text)
